...
function M.setup()
	local group = vim.api.nvim_create_augroup("JosephIncludeFormatter", { clear = true })
	...
	vim.api.nvim_create_autocmd("BufWritePre", {
		...
		callback = function(args)
			...
			require("joseph.tools.include_formatter").format(args.buf)
		end,
	})
	...
	vim.api.nvim_create_user_command("Skel", function()
		require("joseph.tools.skeleton").insert()
	end, {})
	...
	require("joseph.tools.cpp_extract").setup()
	require("joseph.tools.cpp_trivial_constructor").setup()
end
