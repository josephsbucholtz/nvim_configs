return {
	...
	init = function()
		local group = vim.api.nvim_create_augroup("joseph-obsidian-markdown", { clear = true })
		...
		vim.api.nvim_create_autocmd("FileType", {
			...
			callback = function(args)
				...
				require("joseph.core.obsidian").setup_markdown_buffer(args.buf)
			end,
		})
	end,
	opts = function()
		return require("joseph.core.obsidian").opts()
	end,
	config = function(_, opts)
		require("obsidian").setup(opts)
		require("joseph.core.obsidian").patch_template_substitutions()
	end,
}
